export const wordle: { puzzleNumber: number; words: string[] }[] = [
  ...
  { puzzleNumber: 1418, words: ["waste", "truck", "ditch", "pitch"] },
  { puzzleNumber: 1417, words: ["alarm", "level", "livid"] },
  { puzzleNumber: 1416, words: ["ended", "noisy", "canon", "flown", "grown"] },
  { puzzleNumber: 1415, words: ["combs", "prune", "filth", "fifth"] },
  {
    puzzleNumber: 1414,
    words: ["sakes", "label", "raven", "taper", "dazer", "wafer", "eager"],
  },
  { puzzleNumber: 1413, words: ["barfs", "bound", "boxen", "bongo"] },
  { puzzleNumber: 1412, words: ["death", "aorta", "abuts", "amity"] },
  { puzzleNumber: 1411, words: ["gloom", "ready", "erase", "whare", "aware"] },
  { puzzleNumber: 1410, words: ["bribe", "biles", "bided", "bitey", "bicep"] },
  { puzzleNumber: 1409, words: ["coops", "world", "dowel"] },
  { puzzleNumber: 1408, words: ["afire", "beany", "yeast"] },
  { puzzleNumber: 1407, words: ["poles", "tepid", "tripe"] },
  { puzzleNumber: 1406, words: ["niner", "pouts", "baldy", "bally", "balmy"] },
  { puzzleNumber: 1405, words: ["cruds", "scene", "scope", "scale"] },
  {
    puzzleNumber: 1404,
    words: ["marts", "mauve", "mappy", "macaw", "macon", "macho"],
  },
  { puzzleNumber: 1403, words: ["lathe", "wrote", "quite", "suite"] },
  {
    puzzleNumber: 1402,
    words: ["cream", "wroth", "drink", "brill", "frill", "grill"],
  },
  { puzzleNumber: 1401, words: ["sizes", "flour", "grout", "crout", "trout"] },
  { puzzleNumber: 1400, words: ["soaks", "aspen", "apish", "pause", "patsy"] },
  { puzzleNumber: 1399, words: ["frust", "clash", "whose"] },
  { puzzleNumber: 1398, words: ["emits", "tweet", "blert", "cheat", "adept"] },
  { puzzleNumber: 1397, words: ["stuff", "bring", "mirid", "dairy", "idler"] },
  { puzzleNumber: 1396, words: ["frump", "beast", "bliss"] },
  { puzzleNumber: 1395, words: ["prise", "ebony", "feely", "weedy"] },
  ...
  {
    puzzleNumber: 1391,
    words: ["paced", "emits", "feely", "gorge", "ounce", "ozone"],
  },
  ...
  {
    puzzleNumber: 1387,
    words: ["focus", "snowy", "spore", "sloot", "stook", "stood"],
  },
