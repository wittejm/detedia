const data: { puzzleNumber: number; words: string[] }[] = [
  ...
  { puzzleNumber: 866, words: ["foggy", "occur","valor", "abhor", "armor", "ardor"] },
  { puzzleNumber: 865, words: ["whine", "tints","intro", "until"] },
  { puzzleNumber: 864, words: ["chirr", "fowls","leave", "panel", "equal", "bleat"] },
  ...
  { puzzleNumber: 859, words: ["salad", "begin","fiery", "rivet", "winge", "niche", "pique"] },
