const data: { puzzleNumber: number; words: string[] }[] = [
  ...
  { puzzleNumber: 780, words: ["conch", "radar", "fluff", "vulva", "gully", "bully"] },
  ...
  { puzzleNumber: 751, words: ["broke", "colas", "goldy","holly","jolly","folly"] },
  ...
  { puzzleNumber: 743, words: ["total", "dodge", "bombs", "mousy", "mopsy", "mossy"] },
